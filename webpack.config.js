...
module.exports = {
  ...
  output: {
    path: path.join(__dirname, 'seniority_visualizer_app', 'static', 'build'),
  ...
  plugins: [
    ...
    new ManifestRevisionPlugin(path.join(__dirname, 'seniority_visualizer_app', 'webpack', 'manifest.json'), {
      rootAssetPath,
      ignorePaths: ['/js', '/css'],
